...
/**
 * This class implements the side integral for the specific dof on specific side
 */
class SideIntegralValuePostprocessor:public SideIntegralPostprocessorBase{
protected:
    /**
