...
/**
 * This class access the nodal's scalar material value via its global node id
 */
class NodalScalarMatePostprocessor:public NodalPostprocessorBase{
protected:
    /**
...
private:
    ...
    string m_scalarmatename="";/**< the string name of the scalar material */
