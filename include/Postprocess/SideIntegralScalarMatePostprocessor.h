...
/**
 * This class implements the integration of specific scalar material on specific side
 */
class SideIntegralScalarMatePostprocessor:public SideIntegralPostprocessorBase{
protected:
    /**
...
private:
    ...
    double m_scalarvalue=0.0;/**< the scalar value */    
