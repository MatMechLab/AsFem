...
/**
 * This class implements the volume integral calculation of dof's value on specific domain
 */
class VolumeIntegralValuePostprocessor:public VolumeIntegralPostprocessorBase{
protected:
    /**
