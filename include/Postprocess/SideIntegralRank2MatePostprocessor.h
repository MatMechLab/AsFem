...
/**
 * This class implements the integration of specific rank-2 material on specific side
 */
class SideIntegralRank2MatePostprocessor:public SideIntegralPostprocessorBase{
protected:
    /**
