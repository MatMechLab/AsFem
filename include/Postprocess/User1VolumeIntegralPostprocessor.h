...
/**
 * This class implements the volume integral calculation of the user-1 defined expression/formula.
 */
class User1VolumeIntegralPostprocessor:public VolumeIntegralPostprocessorBase{
protected:
    /**
