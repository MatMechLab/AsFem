 ...
 */
class SmallStrainDiffusionJ2Material:public BulkMaterialBase,
                                     public PlasticMaterialBase{
public:
    SmallStrainDiffusionJ2Material();
    ~SmallStrainDiffusionJ2Material();
protected:
    /**
...
private:
    ...
    double m_Omega,m_Cref;/**< partial molar volume and reference concentration */
    Rank2Tensor m_eigenstrain,m_deigenstrain_dc;/** the concentration induced eigen strain */
    Rank2Tensor m_dtotal_strain_dc;/** the derivative of total strain w.r.t. concentration */
    Rank2Tensor m_ddev_strain_dc;/**< the dev strain's derivative w.r.t. concentration */
    Rank2Tensor m_dstress_trial_dc;/**< the derivative of trial stress w.r.t. concentration */
    Rank2Tensor m_dN_dc;/**< the derivative of N tensor w.r.t. concentration */
