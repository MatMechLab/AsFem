...
/**
 * This class calculate the sigma and F for the 1d poisson equation, which is a standard benchmark test.
 */
class Poisson1DBenchmarkMaterial:public BulkMaterialBase{
protected:
    /**
