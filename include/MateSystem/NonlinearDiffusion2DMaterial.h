...
/**
 * This class calculate the sigma and F for the 2d nonlinear diffusion equation, 
 * which is a standard benchmark test.
 */
class NonlinearDiffusion2DMaterial:public BulkMaterialBase{
protected:
    /**
