 ...
 */
class DiffusionACFractureMaterial:public BulkMaterialBase,
                                  public FreeEnergyMaterialBase,
                                  public ElasticMaterialBase{
public:
    DiffusionACFractureMaterial();
    ~DiffusionACFractureMaterial();
protected:
    /**
...
private:
    ...
    Rank2Tensor m_strain,m_mech_strain,m_dmechstrain_dc;/**< the different strains */
    Rank2Tensor m_strain_pos,m_strain_neg;/**< the positive and negative part of the mechanical strain */
    Rank2Tensor m_dstrainpos_dc,m_dstrainneg_dc;/**< the positive and negative part of the mechanical strain's derivatives */

    Rank2Tensor m_stress,m_dstress_dD,m_dstress_dc;/**< the stress and its derivatives */
    Rank2Tensor m_stress_pos,m_stress_neg;/**< the positive and negative stress */
    Rank2Tensor m_dstresspos_dc,m_dstressneg_dc;/**< the positive and negative stress's derivatives */
