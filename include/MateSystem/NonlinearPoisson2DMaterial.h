...
/**
 * This class calculate the sigma and F for the 2d nonlinear poisson equation, which is a standard benchmark test.
 */
class NonlinearPoisson2DMaterial:public BulkMaterialBase{
protected:
    /**
