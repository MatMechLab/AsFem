...
//+++ Author : Yang Bai
//+++ Date   : 2022.05.14
//+++ Purpose: defines the base class of 2d shape functions in AsFem
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
/**
 * The base class for 2d lagrange shape function
 */
class ShapeFun2DBase{
public:
    /**
     ...
     */
    virtual void calc2DShapeValsAndDerivatives(const double &xi,const double &eta,vector<double> &t_shpvals,vector<Vector3d> &t_shpders)=0;
