...
/**
 * This class implement the calculation of diffusion coupled allen-cahn type phase-field fracture equations
 */
class DiffusionACFractureElement:public BulkElmtBase{
public:
    /**
