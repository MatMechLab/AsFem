...
//+++          stress-diffusion equilibrium equation
//+++          governing equation:
//+++          1) dc/dt=div(D*grad(c)+Dc*grad(sigma_H))
//+++          2) v*dd/dt=delta f/delta d
//+++          3) div(sigma)=0
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
/**
 * This class implement the calculation of stress-diffusion-fracture equation
 */
class DiffusionFractureElmt:public BulkElmtBase{
public:
    /**
...
private:
    /**
     * This function calculate the residual of the stress equilibrium and diffusion equation. <br>
     */
    ...
    /**
     * This function calculate the jacobian matrix of the stress equilibrium and diffusion quation. <br>
     */
...
private:
    RankTwoTensor Stress,dStressdC,dStressdD,dHdstrain;
    Vector3d GradSigmaH;
    double D,Omega,dSigmaHdC;
    double viscosity,Gc,L,Hist;
