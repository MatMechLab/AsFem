...
Lagrange2DQuad9MeshCellGenerator::Lagrange2DQuad9MeshCellGenerator(){
...
//*********************************************************
bool Lagrange2DQuad9MeshCellGenerator::generateFECell(FECellData &t_celldata){
    int rank,size;
    t_celldata.MaxDim=2;
    t_celldata.MinDim=1;
    ...
    if(rank==0){
        ...
        t_celldata.BulkMeshTypeName="quad9";
        ...
        t_celldata.NodesNum=(2*t_celldata.Nx+1)*(2*t_celldata.Ny+1);
        t_celldata.NodesNumPerBulkElmt=9;
        t_celldata.NodesNumPerSurfElmt=0;
        t_celldata.NodesNumPerLineElmt=3;
            
        t_celldata.BulkElmtVTKCellType=28;
        t_celldata.BulkElmtMeshType=MeshType::QUAD9;
        ...
        for(j=1;j<=2*t_celldata.Ny+1;j++){
            for(i=1;i<=2*t_celldata.Nx+1;i++){
                k=(j-1)*(2*t_celldata.Nx+1)+i;
        ...
        for(j=1;j<=t_celldata.Ny;j++){
            for(i=1;i<=t_celldata.Nx;i++){
                ...
                i1=(j-1)*2*(2*t_celldata.Nx+1)+2*i-1;
                i2=i1+2;
                i3=i2+2*(2*t_celldata.Nx+1);
                i4=i3-2;

                i5=i1+1;
                i6=i2+(2*t_celldata.Nx+1);
                i7=i3-1;
                i8=i1+(2*t_celldata.Nx+1);
                i9=i8+1;
                ...
                t_celldata.MeshCell_Total[e-1].VTKCellType=28;
                t_celldata.MeshCell_Total[e-1].NodesNumPerElmt=9;
                ...
                t_celldata.MeshCell_Total[e-1].ElmtNodeCoords.resize(9);
                ...
                // the layout of your quad9 should be:
                // 4--7--3
                // |     |
                // 8  9  6
                // |     |
                ...
                if(j==1){
                    ...
                    //
                    bottomconn[i-1].ElmtNodeCoords(2,1)=t_celldata.NodeCoords_Global[(i5-1)*3+1-1];
                    bottomconn[i-1].ElmtNodeCoords(2,2)=t_celldata.NodeCoords_Global[(i5-1)*3+2-1];
                    bottomconn[i-1].ElmtNodeCoords(2,3)=t_celldata.NodeCoords_Global[(i5-1)*3+3-1];
                    //
                    bottomconn[i-1].ElmtNodeCoords(3,1)=t_celldata.NodeCoords_Global[(i2-1)*3+1-1];
                    bottomconn[i-1].ElmtNodeCoords(3,2)=t_celldata.NodeCoords_Global[(i2-1)*3+2-1];
                    bottomconn[i-1].ElmtNodeCoords(3,3)=t_celldata.NodeCoords_Global[(i2-1)*3+3-1];
                    //
                ...
                if(j==t_celldata.Ny){
                    ...
                    //
                    topconn[i-1].ElmtNodeCoords(2,1)=t_celldata.NodeCoords_Global[(i7-1)*3+1-1];
                    topconn[i-1].ElmtNodeCoords(2,2)=t_celldata.NodeCoords_Global[(i7-1)*3+2-1];
                    topconn[i-1].ElmtNodeCoords(2,3)=t_celldata.NodeCoords_Global[(i7-1)*3+3-1];
                    //
                    topconn[i-1].ElmtNodeCoords(3,1)=t_celldata.NodeCoords_Global[(i4-1)*3+1-1];
                    topconn[i-1].ElmtNodeCoords(3,2)=t_celldata.NodeCoords_Global[(i4-1)*3+2-1];
                    topconn[i-1].ElmtNodeCoords(3,3)=t_celldata.NodeCoords_Global[(i4-1)*3+3-1];
                    //
                ...
                if(i==1){
                    ...
                    //
                    leftconn[j-1].ElmtNodeCoords(2,1)=t_celldata.NodeCoords_Global[(i8-1)*3+1-1];
                    leftconn[j-1].ElmtNodeCoords(2,2)=t_celldata.NodeCoords_Global[(i8-1)*3+2-1];
                    leftconn[j-1].ElmtNodeCoords(2,3)=t_celldata.NodeCoords_Global[(i8-1)*3+3-1];
                    //
                    leftconn[j-1].ElmtNodeCoords(3,1)=t_celldata.NodeCoords_Global[(i1-1)*3+1-1];
                    leftconn[j-1].ElmtNodeCoords(3,2)=t_celldata.NodeCoords_Global[(i1-1)*3+2-1];
                    leftconn[j-1].ElmtNodeCoords(3,3)=t_celldata.NodeCoords_Global[(i1-1)*3+3-1];
                    //
                    leftconn[j-1].ElmtNodeCoords0=leftconn[1-1].ElmtNodeCoords;
                ...
                if(i==t_celldata.Nx){
                    ...
                    //
                    rightconn[j-1].ElmtNodeCoords(2,1)=t_celldata.NodeCoords_Global[(i6-1)*3+1-1];
                    rightconn[j-1].ElmtNodeCoords(2,2)=t_celldata.NodeCoords_Global[(i6-1)*3+2-1];
                    rightconn[j-1].ElmtNodeCoords(2,3)=t_celldata.NodeCoords_Global[(i6-1)*3+3-1];
                    //
                    rightconn[j-1].ElmtNodeCoords(3,1)=t_celldata.NodeCoords_Global[(i3-1)*3+1-1];
                    rightconn[j-1].ElmtNodeCoords(3,2)=t_celldata.NodeCoords_Global[(i3-1)*3+2-1];
                    rightconn[j-1].ElmtNodeCoords(3,3)=t_celldata.NodeCoords_Global[(i3-1)*3+3-1];
                    //
