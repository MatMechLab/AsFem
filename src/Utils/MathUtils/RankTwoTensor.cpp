...
:_N(3),_N2(3*3){
    switch(method){
        ...
        case InitMethod::InitRandom:
            ...
            break;
        default:
            MessagePrinter::PrintErrorTxt("unsupported rank-2 tensor fill in method !");
...
void RankTwoTensor::SetRotationTensorFromEulerAngle(const double &theta1,const double &theta2,const double &theta3){
