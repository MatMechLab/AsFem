...
int Gmsh4IO::GetElmtNodesNumFromGmshElmtType(const int &elmttype) const{
    switch(elmttype){
        case 1:
            // 2-node line
            return 2;
...
//******************************************************
int Gmsh4IO::GetElmtDimFromGmshElmtType(const int &elmttype) const{
    switch(elmttype){
        case 1:
            // 2-node line
            return 1;
...
//**************************************************
int Gmsh4IO::GetElmtOrderFromGmshElmtType(const int &elmttype)const{
    switch(elmttype){
        case 1:
            // 2-node line
            return 1;
...
//***************************************************************
MeshType Gmsh4IO::GetElmtMeshTypeFromGmshElmtType(const int &elmttype)const{
    switch(elmttype){
        case 1:
            // 2-node line
...
string Gmsh4IO::GetElmtTypeNameFromGmshElmtType(const int &elmttype)const{
    switch(elmttype){
        case 1:
            // 2-node line
            return "edge2";
...
//****************************************************************
int Gmsh4IO::GetSubElmtNodesNumFromGmshElmtType(const int &elmttype) const{
    switch(elmttype){
        case 1:
            // 2-node line
            return 1;
...
//***************************************************************
int Gmsh4IO::GetSubElmtDimFromGmshElmtType(const int &elmttype) const{
    switch(elmttype){
        case 1:
            // 2-node line
            return 1-1;
...
//*************************************************************
int Gmsh4IO::GetSubElmtOrderFromGmshElmtType(const int &elmttype)const{
    switch(elmttype){
        case 1:
            // 2-node line
            return 1;
...
//*************************************************************
MeshType Gmsh4IO::GetSubElmtMeshTypeFromGmshElmtType(const int &elmttype)const{
    switch(elmttype){
        case 1:
            // 2-node line
            return MeshType::POINT;
...
//*******************************************************************
int Gmsh4IO::GetElmtVTKCellTypeFromGmshElmtType(const int &elmttype)const{
    switch(elmttype){
        case 1:
            // 2-node line
            return 3;
...
//*******************************************************************
int Gmsh4IO::GetPhysicalIDViaEntityTag(const int &ndim,const int &tag)const{
    if(ndim==0){
        return _PointsEntityPhyIDs[tag-1];
    }
    else if(ndim==1){
        return _CurvesEntityPhyIDS[tag-1];
    }
    else if(ndim==2){
        return _SurfaceEntityPhyIDs[tag-1];
    }
    else if(ndim==3){
        return _VolumesEntityPhyIDs[tag-1];
    }
    return -1;
}
