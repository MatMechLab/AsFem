...
//+++ Author : Yang Bai
//+++ Date   : 2021.09.04
//+++ Purpose: implement the residual and jacobian for the UEL13
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
void User13Elmt::ComputeAll(const FECalcType &calctype,const LocalElmtInfo &elmtinfo,const double (&ctan)[2],
    ...
    if(calctype==FECalcType::ComputeResidual){
        ...
        MessagePrinter::PrintErrorTxt("unsupported calculation type in User13Elmt, please check your related code");
        MessagePrinter::AsFem_Exit();
    }
}
//***************************************************************************
void User13Elmt::ComputeResidual(const LocalElmtInfo &elmtinfo,
