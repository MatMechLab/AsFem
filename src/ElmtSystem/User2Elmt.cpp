...
void BulkElmtSystem::User2Elmt(const FECalcType &calctype, const int &nDim, const int &nNodes, const int &nDofs,
    ...
    switch (calctype){
        ...
        case FECalcType::Projection:
            break;
        default:
            MessagePrinter::PrintErrorTxt("unsupported FEM calculation type in User2 element");
