...
void BulkElmtSystem::LaplaceElmt(const FECalcType &calctype,
    ...
    //*******************************************************
    if(nDim||nNodes||t||dt||ctan[0]||gpCoords(1)||gpV[0]||
       gpGradV[0](1)||ScalarMaterials[0]||VectorMaterials[0](1)||
       test||trial||Rank2Materials.size()||Rank4Materials.size()||
    ...
    case FECalcType::ComputeJacobian:
        localK(1,1)=grad_test*grad_trial;
        break;
