...
//+++ Author : Yang Bai
//+++ Date   : 2022.06.05
//+++ Purpose: implement the user3 gauss point generator
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

#include "FE/QPointUser3Generator.h"

void QPointUser3Generator::generateQPoints(const int &t_dim,const int &t_order,const MeshType &t_meshtype,int &t_ngp,vector<double> &t_qpoints){
    //************************************************************
