...
//+++ Author : Yang Bai
//+++ Date   : 2021.10.06
//+++ Purpose: implement the user-4 dirichlet boundary condition
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

#include "BCSystem/User4DirichletBC.h"

User4DirichletBC::User4DirichletBC(){
    m_localU.resize(11,0.0);// the maximum dofs of each bc block is 10!
}

void User4DirichletBC::computeBCValue(const FECalcType &calctype,const double &penalty,const double &bcvalue,const nlohmann::json &json,
...
void User4DirichletBC::computeU(const double &bcvalue,const nlohmann::json &json,const vector<int> &dofids,
                          const LocalElmtInfo &elmtinfo,
                          const LocalElmtSolution &elmtsoln,
                          VectorXd &localU){
    ...
    //     localU(i)=bcvalue;
    // }
    MessagePrinter::printErrorTxt("User-4 dirichlet bc has not be implemented yet, please update your code in User1DirichletBC.cpp");
