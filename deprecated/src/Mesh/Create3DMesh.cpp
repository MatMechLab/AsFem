...
void Mesh::Create3DMesh()
{
    ...
    if(_MeshType=="hex8")
    {
        ...
        _BulkElmtType=MeshType::HEX8;
        _SurfaceElmtType=MeshType::QUAD4;
        ...
        for(k=1;k<=_Nz;k++){
            for(j=1;j<=_Ny;j++){
                for(i=1;i<=_Nx;i++){
                    ...
                    _CellVTKType[e-1+_nElmts-_nBulkElmts]=_VTKCellType;
    ...
    else if(_MeshType=="hex20")
    {
        ...
        _BulkElmtType=MeshType::HEX20;
        _SurfaceElmtType=MeshType::QUAD8;
    ...
    else if(_MeshType=="hex27")
    {
        ...
        _BulkElmtType=MeshType::HEX27;
        _SurfaceElmtType=MeshType::QUAD9;
        _LineElmtType=MeshType::EDGE3;
    ...
    _PhyGroupNameList.push_back("back");
    _PhyGroupNameList.push_back("front");
    ...
    _PhyNameToIDList.push_back(make_pair("back",  5));
    _PhyNameToIDList.push_back(make_pair("front", 6));
    _PhyNameToIDList.push_back(make_pair("alldomain",7));
    ...
    _PhyIDToNameList.push_back(make_pair(5,"back"));
    _PhyIDToNameList.push_back(make_pair(6,"front"));
    _PhyIDToNameList.push_back(make_pair(7,"alldomain"));
    ...
    _PhyNameToElmtIndexList.push_back(make_pair("back",back));
    _PhyNameToElmtIndexList.push_back(make_pair("front",front));
