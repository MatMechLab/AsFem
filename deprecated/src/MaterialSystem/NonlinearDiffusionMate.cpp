...
void MaterialSystem::NonlinearDiffusionMate(const int &nDim,const double &t,const double &dt,
    ...
    if(InputParams.size()<1){
        cout<<"*** Error: for nonlineardiff mate, one param is required!!!***"<<endl;
        Msg_AsFem_Exit();
    }
    ...
    _MateValues[0]=InputParams[0]*(1.5+sin(gpCoord(0))*cos(gpCoord(1)));// D
